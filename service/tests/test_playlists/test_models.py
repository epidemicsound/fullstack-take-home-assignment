...
class PlaylistTrackModelTestCase(TestCase):
    def setUp(self):
        self.track = Track.objects.create(id="track_1", title="Track 1")
    ...
    def test_create_playlist_track(self):
        ...
        self.assertEqual(playlist_track.track, self.track)
        self.assertEqual(playlist_track.playlist, self.playlist)

    def test_unique_together_constraint(self):
        PlaylistTrack.objects.create(track=self.track, playlist=self.playlist, order=1)
    ...
    def test_get_latest_by_order(self):
        ...
        self.assertEqual(latest_track, playlist_track2)
